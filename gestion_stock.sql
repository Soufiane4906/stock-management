...
DROP DATABASE IF EXISTS `gestion_stock_dclick`;

-- Création de la base de données
CREATE DATABASE `gestion_stock_dclick` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;

-- Utilisation de la base de données
USE `gestion_stock_dclick`;
...
('admin', 'admin@dclic.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Wissal Admin', 'admin'),
('wissal', 'wissal@dclic.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Wissal', 'admin');
...
INSERT INTO `contact` (`id`, `nom`, `prenom`, `email`, `numero_de_telephone`)
VALUES
    (1, 'Jaharou', 'Amadou', 'j.amadou@example.com', '1234567890'),
    (2, 'Wissal', 'Benkirane', 'wissal.benkirane@example.com', '9876543210');
